import {
    SET_ACTIVE_CATEGORY, SEARCHED_VIDEOS_REQUEST, SEARCHED_VIDEOS_SUCCESS, SEARCHED_VIDEOS_FAILED,
    LIKED_VIDEOS_SUCCESS, LIKED_VIDEOS_REQUEST, LIKED_VIDEOS_FAILED, SUBSCRIPTIONS_VIDEOS_REQUEST, SUBSCRIPTIONS_VIDEOS_SUCCESS, SUBSCRIPTIONS_VIDEOS_FAILED, RELATED_VIDEOS_REQUEST, RELATED_VIDEOS_SUCCESS, RELATED_VIDEOS_FAILED, HOME_VIDEOS_SUCCESS, HOME_VIDEOS_FAILED, HOME_VIDEOS_REQUEST, SELECTED_VIDEO_REQUEST, SELECTED_VIDEO_SUCCESS
} from "../types"
...
export const homeVideosReducer = (state = initialState, action) => {
    ...
    switch (type) {
        ...
        case HOME_VIDEOS_SUCCESS:
            ...
            return {
                ...state,
                videos: payload.category === state.previousCategory ? [...state.videos, ...payload.videos] : payload.videos,
